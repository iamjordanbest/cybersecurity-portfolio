...
def run_project_2():
    """Run Project 2: Cloud Security Posture Management"""
    print("\nLaunching Project 2: Cloud Security Auditor...")
    script_path = Path("project-2-cloud-security/cli.py")
    if not script_path.exists():
        print(f"Error: {script_path} not found.")
        return
...
def run_project_3():
    """Run Project 3: Vulnerability Automation"""
    print("\nLaunching Project 3: Vulnerability Automation...")
    script_path = Path("project-3-vulnerability-automation/src/parser.py")
    if not script_path.exists():
        print(f"Error: {script_path} not found.")
        return
...
def main():
    ...
    parser.add_argument('project', choices=['1', '1-api', '2', '3', 'all'], nargs='?', help="Project to run")
    ...
    if args.list:
        ...
        print("  2.     Cloud Security Posture Management (AWS Auditor)")
        print("  3.     Vulnerability Automation System (Parser)")
        return
    ...
    if args.project == '1':
        ...
        print("  python run_portfolio.py 1      -> Run Project 1 (ML Pipeline)")
        print("  python run_portfolio.py 1-api  -> Run Project 1 (ML API)")
        print("  python run_portfolio.py 2      -> Run Project 2 (Cloud Security)")
        print("  python run_portfolio.py 3      -> Run Project 3 (Vulnerability)")
